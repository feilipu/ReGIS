...
To try this out, hook up two serial devices to your laptop and cross them.
...
For convenience, use the script `xterm.sh` to launch a local `xterm` build, and
`regis.sh` to send a demo command sequence.
